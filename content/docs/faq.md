...
Short answers to the questions people ask most. If yours is not here, reach the developer through the in-app feedback screen.

## Is Kuber really offline?

Yes. Kuber works fully offline. There is no account and no cloud. Your data never leaves your phone.
...
On your device, in a secure on-device database. There are no remote servers involved.

## How do I back up or move my data?

Export a local JSON or CSV backup from inside the app. The file is yours, and you can import it back whenever you need.
...
Kuber is available for Android on the Google Play Store.
